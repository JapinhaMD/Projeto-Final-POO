...
public class PedidoRepositoryMySql : PedidoRepository
{
    private MySqlConnection _mySqlConnection =
        new MySqlConnection("Persist Security Info=False;server=localhost;database=fastfoodorder;uid=root;password=''");
    ...
    public void Adicionar(Pedido pedido)
    {
        ...
        cmd.CommandText =
            "INSERT INTO PEDIDO(data, cliente, status) VALUES(@data, @nome, @status); SELECT LAST_INSERT_ID();";
